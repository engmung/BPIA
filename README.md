...
3. In Windows, run the `install.bat` file.
   
   In Mac,
     1) Select the BPIA-master folder in the finder and press the `command+option+c` to copy the file path.  
...
7. Open the Blender file and execute the script inside.
